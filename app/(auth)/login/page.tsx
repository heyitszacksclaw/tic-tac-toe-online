        ...
        <div className="card-elevated p-8">
          ...
          <div className="flex flex-col gap-3 mb-7">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-xl bg-[var(--color-surface-light)] hover:bg-[var(--color-surface-hover)] border border-[var(--color-border-strong)] hover:border-[var(--color-border-strong)] transition-all duration-150 text-sm font-medium"
            >
